...
/**
 * help_cd - Displays information on the shells builtin command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit - Displays information on the shells builtin command 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help - Displays information on the shells builtin command 'help'.
 */
void help_help(void)
{
